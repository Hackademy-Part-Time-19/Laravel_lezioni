...
Route::get('user/phone/create',[UserController::class,'create'])->name('phone.create')->middleware('auth');
Route::post('user/phone/store',[UserController::class,'store'])->name('phone.store')->middleware('auth');